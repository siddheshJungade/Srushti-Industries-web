    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="header-top-left col-md-auto col-12">
                <p><span>Phone:</span> +91 830 820 8279</p>
                <p><span>Email:</span> srushtiindus@gmail.com</p>
            </div>
            <!-- Header Top Right -->
            <div class="header-top-right col-md-auto col-12 d-none d-md-flex">
                ...
                <!-- Header Quote Button -->
                <a href="contact-us/" class="get-quote">get a qoute</a>
            </div>
        </div>
    </div>
</div>
...
<div class="header-bottom">
    <div class="container">
        <div class="row">
			<!-- Logo -->
			<div class="header-logo col align-self-center"><a class="logo" href="index"><img src="img/srushti.png" alt=""></a></div>
			<!-- Main Menu -->
